...
accessionID = 'GSE107011'        # GSE ID
experimentType = 'rna'     # m or rna      (microarray or RNA-Seq)
norm = 'None'               # tpm/cpm/None  Need to normalize data (already TPM)
takeLog = 'True'            # True/False    need to take log of data (data is not log normalized yet)
raw = 'False'              # True/False    RNA-Seq raw data?
all_files = False        # True/False    True: generate all files; False: only generate surv and ih
